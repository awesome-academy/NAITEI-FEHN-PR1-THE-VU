...
export default function RequestPlant() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.suggest_tree.description || formData.suggest_tree.description.length < 20) {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/requests', updatedFormData);
            ...
            <div className="space-y-2">
              ...
              <div className="mt-1">
                ...
                <p className="text-sm text-gray-500">
                  Tải lên hình ảnh của cây để chúng tôi có thể hiểu rõ hơn về yêu cầu của bạn.
                </p>
              </div>
            </div>
